...
public class ImageAdapter extends BaseAdapter {
	...
	private ArrayList<MapItem> mImageItems;

	private ImageView[] mImages;

	public ImageAdapter( Activity activity, ArrayList<MapItem> images) {
		mActivity = activity;
	...
	public boolean createReflectedImages() {
		...
		int index = 0;
		for (final MapItem image : mImageItems) {
			Bitmap originalImage = BitmapFactory.decodeFile(image.getSnippet(), options);
