...
public class CoverFlow extends CoverAbsSpinner implements
	...
	private static final int GALLERY_STYLE = 16842864;
	...
	public CoverFlow(Context context, AttributeSet attrs) {
		this(context, attrs, GALLERY_STYLE);
	}
	...
	public CoverFlow(Context context, AttributeSet attrs, int defStyle) {
		...
		tvDate = (TextView) mActivity
				.findViewById(R.id.slide_date_data);
		tvTime = (TextView) mActivity
				.findViewById(R.id.slide_time_data);
		tvPlace = (TextView) mActivity
				.findViewById(R.id.slide_place_data);
	...
	private void updateSelectedItemMetadata() {
		...
		MapItem touchedItem = (MapItem) mAdapter.getItem(mSelectedPosition);

		if (touchedItem != null) {

			if (touchedItem.getAddress() != "") {
				tvPlace.setText(touchedItem.getAddress());
			} else {
				tvPlace.setText("-");
			}

			Date tmpDate = Util.timestamp2Date(touchedItem.getTimeStamp());

			tvDate.setText(tmpDate.toLocaleString().substring(0, 10));
			tvTime.setText(tmpDate.toLocaleString().substring(11));
		}
	...
	private void startZoomActivity() {
		...
		MapItem currItem = (MapItem) mAdapter.getItem(mSelectedPosition);

		if (currItem != null) {

			Intent zoomIntent = new Intent(ctx, ImageZoomActivity.class);
			zoomIntent.putExtra("image_patch", currItem.getSnippet());

			ctx.startActivity(zoomIntent);
		}
	}
}